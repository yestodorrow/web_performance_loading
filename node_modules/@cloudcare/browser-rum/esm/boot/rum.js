...
import { LifeCycle, LifeCycleEventType, createPageExitObservable, canUseEventBridge, startTelemetry, getEventBridge, TelemetryService } from '@cloudcare/browser-core';
...
export function startRum(configuration, recorderApi, globalContextManager, userContextManager, initialViewOptions) {
  var cleanupTasks = [];
...
export function startRumEventCollection(lifeCycle, configuration, location, sessionManager, userSessionManager, locationChangeObservable, domMutationObservable, buildCommonContext, reportError) {
