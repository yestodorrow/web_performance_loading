import { timeStampNow, Observable, assign, getRelativeTime, ONE_MINUTE, ContextHistory, UUID, clocksNow, ONE_SECOND, elapsed, each, map, LifeCycleEventType, ActionType, isNullUndefinedDefaultValue, isArray, includes } from '@cloudcare/browser-core';
import { trackEventCounts } from '../../trackEventCounts';
import { waitPageActivityEnd, PAGE_ACTIVITY_VALIDATION_DELAY } from '../../waitPageActivityEnd';
