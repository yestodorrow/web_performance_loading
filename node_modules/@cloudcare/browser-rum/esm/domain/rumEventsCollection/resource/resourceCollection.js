import { getStatusGroup, UUID, extend2Lev, relativeToClocks, urlParse, getQueryParamsFromUrl, replaceNumberCharByPath, RequestType, ResourceType, RumEventType, LifeCycleEventType, toServerDuration, some, isNullUndefinedDefaultValue } from '@cloudcare/browser-core';
import { matchRequestTiming } from './matchRequestTiming';
import { computePerformanceResourceDetails, computePerformanceResourceDuration, computeResourceKind, computeSize, isRequestKind, is304, isCacheHit, isResourceUrlLimit, isLongDataUrl, sanitizeDataUrl } from './resourceUtils';
