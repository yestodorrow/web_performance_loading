import { ONE_SECOND, LifeCycleEventType, isPageExitReason, setTimeout, clearTimeout } from '@cloudcare/browser-core';
...
export function computeSegmentContext(configuration, sessionManager, viewContexts) {
...
export function setSegmentBytesLimit() {
