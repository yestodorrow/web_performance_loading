...
export var convertMouseEventToLayoutCoordinates = function convertMouseEventToLayoutCoordinates(clientX, clientY) {
  var visual = window.visualViewport;
  var normalised = {
...
export var getVisualViewport = function getVisualViewport() {
  var visual = window.visualViewport;
  return {
    scale: visual.scale,
