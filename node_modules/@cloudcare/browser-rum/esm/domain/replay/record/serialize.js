...
import { assign, startsWith, isNodeShadowRoot, forEachChildNodes, hasChildNodes } from '@cloudcare/browser-core';
...
import { getTextContent, shouldMaskNode, reducePrivacyLevel, getNodeSelfPrivacyLevel } from './privacy';
import { getSerializedNodeId, setSerializedNodeId, getElementInputValue, switchToAbsoluteUrl, serializeStyleSheets, absoluteToDoc, getAbsoluteSrcsetString, isSVGElement, getHref, getCssRulesString } from './serializationUtils';
import { isLongDataUrl, sanitizeDataUrl } from '../../rumEventsCollection/resource/resourceUtils';
