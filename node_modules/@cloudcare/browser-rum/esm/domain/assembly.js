import { extend2Lev, withSnakeCaseKeys, timeStampNow, isEmptyObject, LifeCycleEventType, RumEventType, deviceInfo, currentDrift, createEventRateLimiter, limitModification, display, assign, round } from '@cloudcare/browser-core';
var SessionType = {
...
export function startRumAssembly(configuration, lifeCycle, sessionManager, userSessionManager, viewContexts, urlContexts, actionContexts, displayContext, buildCommonContext, reportError) {
