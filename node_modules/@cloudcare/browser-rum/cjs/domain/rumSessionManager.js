...
exports.RumTrackingType = exports.RumSessionPlan = exports.RUM_SESSION_KEY = void 0;
...
exports.RumSessionPlan = RumSessionPlan;
var RumTrackingType = {
  NOT_TRACKED: '0',
...
function startRumSessionManager(configuration, lifeCycle) {
  var sessionManager = (0, _browserCore.startSessionManager)(configuration.cookieOptions, RUM_SESSION_KEY, function (rawTrackingType) {
    return computeSessionState(configuration, rawTrackingType);
  });
  sessionManager.expireObservable.subscribe(function () {
    lifeCycle.notify(_browserCore.LifeCycleEventType.SESSION_EXPIRED);
  });
  sessionManager.renewObservable.subscribe(function () {
    lifeCycle.notify(_browserCore.LifeCycleEventType.SESSION_RENEWED);
  });
  return {
...
function computeSessionState(configuration, rawTrackingType) {
  ...
  } else if (!(0, _browserCore.performDraw)(configuration.sessionSampleRate)) {
    trackingType = RumTrackingType.NOT_TRACKED;
  } else if (!(0, _browserCore.performDraw)(configuration.sessionReplaySampleRate)) {
